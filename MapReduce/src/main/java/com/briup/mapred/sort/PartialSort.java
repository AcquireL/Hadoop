...
public class PartialSort extends Configured implements Tool{
	...
	public static class PSMapper extends 
	...
	public static class PSReducer 
		extends Reducer<DoubleWritable, Text,
			DoubleWritable, Text>{
		@Override
		protected void reduce(DoubleWritable key,
			Iterable<Text> values,
				Reducer<DoubleWritable, Text,
				DoubleWritable, Text>.Context context)
				throws IOException, InterruptedException {
			//原样输出是怎么写的
